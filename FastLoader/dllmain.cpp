...
constexpr uint64_t ENGINE_UPDATE_HOOK_TARGET_ADDRESS = 0x0000000140184CD0;
constexpr uint64_t CURRENT_GAME_STATE_ADDRESS = 0x0000000140E8E080;
constexpr uint64_t UPDATE_TASKS_ADDRESS = 0x0000000140193990;
constexpr uint64_t DATA_INIT_STATE_ADDRESS = 0x0000000140E8E018;
constexpr uint64_t SYSTEM_WARNING_ELAPSED_ADDRESS = (0x00000001410EB400 + 0x68);
