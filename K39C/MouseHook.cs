    ...
    public static class MouseHook
    {
        ...
        private static IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0 && (
                ...
                ((MouseMessages.WM_MOUSEMOVE == (MouseMessages)wParam) && isMouseDown)
                ))
            {
                ...
                MouseEventArgs mea = new MouseEventArgs(isMouseDown ? MouseButtons.Left : MouseButtons.None, 1, hookStruct.pt.x, hookStruct.pt.y, 0);
                MouseAction(null, mea);
            }
